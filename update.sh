...
run_update() {
    ...
    wget -qO- fv-tunnel "https://raw.githubusercontent.com/galihbengkulu777/ppl/main/config/fv-tunnel" 
    chmod +x fv-tunnel 
    bash fv-tunnel
    rm -rf fv-tunnel
    ...
    wget https://github.com/galihbengkulu777/ppl/raw/refs/heads/main/menu/menu.zip
    ...
    wget -q -O /usr/local/sbin/menu https://raw.githubusercontent.com/galihbengkulu777/ppl/main/menu/menu
